                ...
                <div class="row flex-1 g-0">
                    <div class="col-lg-6 h-100 my-auto">
                        ...
                        <div class="creative-card-body card-body p-sm-5">
                            ...
                            <form class="w-100 mt-4 pt-2" method="POST" action="{{ route('password.email') }}">
                                @csrf
                                <div class="mb-4">
                                    <input class="form-control @error('email') is-invalid @enderror" placeholder="Email" id="email" name="email" value="{{ old('email') }}" required>
                                    @error('email')
