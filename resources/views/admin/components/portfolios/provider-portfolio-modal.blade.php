                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-4">
                                <div class="showcase form-group card">
                                    <span class="bordered rounded text-danger">Drop image here</span>
                                    <div id="dropZone"
                                        class="p-3 cursor-pointer  my-2 border d-flex justify-content-center">
                                        <img id="imageDisplay" src="{{ asset('assets/imgs/default/default.webp') }}"
                                            alt="Your Image" class="ursor-pointer "
                                            style="max-width: 100%; width: auto; height: 200px;" />
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-4">
                                <label class="form-label">Indicate the fields of expertise requested for the work you
                                    delivered.</label>
                                <select class="form-control" data-select2-selector="status" name="service_id">
                                    ...
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}" data-bg="bg-warning">{{ $service->name_en }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="mb-4">
                                <label class="form-label">Indicate what were the skills or competences needed from your
                                    team to deliver the work requested.<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="skills" required
                                    placeholder="selcet...">
                            </div>
                        </div>
                        <div class="col-md-12 mt-3 py-2 border rounded">
                            <h4 class="mb-1">Period of collaboration</h4>
                            <span class="text-end">Indicate the starting and ending date of your collaboration with the
                                client on this work.</span>
                            <div>
                                <h5> Start date </h5>
                                <div class="mb-4">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" required name="budget"
                                    placeholder="Enter a budjet...">
                                <label class="form-label">Confidential: This information won’t be visible publicly but
                                    will help us send you more accurate and relevant opportunities.<span
                                        class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="my-3">
                                ...
                                <label class="form-label">Describe the details of your collaboration with the client on
                                    the work delivered.</label>
                            </div>
                            <div class="mb-4">
                                <div class="form-group">
                                    <h6> Introduction</h6>
                                    <label class="form-label">As an introduction, briefly describe the work delivered
                                        in a few sentences.</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <label class="form-label">As an introduction, briefly describe the work delivered
                                        in a few sentences.</label>
                                    <textarea class="form-control" id="exampleTextarea" name="impact" rows="5" placeholder="Enter text here..."></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="mb-4">
                                <label class="form-label">Provide a link to the result of your collaboration (e.g. A
                                    link to the website, the video, the event).</label>
                                <input type="text" class="form-control" name="link"
                                    placeholder="Enter a link for you work...">
                            </div>
                        </div>
                ...
                <div class="col-md-5 sticky-column ">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-4">
                                <select class="form-control" data-select2-selector="status" name="sector">
                                    ...
                                    <option value="Clothing & Accessories" data-bg="bg-success">Clothing & Accessories
                                    </option>
                                    <option value="Consumer Electronics" data-bg="bg-danger">Consumer Electronics
                                    </option>
                                    <option value="Energy & Oil" data-bg="bg-warning">Energy & Oil</option>
                                    <option value="Banking & Financials" data-bg="bg-secondary">Banking & Financials
                                    </option>
                                    <option value="Government & Administration" data-bg="bg-success">Government &
                                        Administration</option>
                                    <option value="Food" data-bg="bg-danger">Food</option>
                                    <option value="Hospitals & Healthcare" data-bg="bg-warning">Hospitals & Healthcare
                                    </option>
                                    <option value="Household Products" data-bg="bg-secondary">Household Products
                                    </option>
                                    <option value="Industrial Goods & Services" data-bg="bg-success">Industrial Goods
                                        & Services</option>
                                    ...
                                    <option value="Pharmaceuticals & Biotech" data-bg="bg-success">Pharmaceuticals &
                                        Biotech</option>
                                    <option value="Retail" data-bg="bg-danger">Retail</option>
                                    <option value="Software & Computer Services" data-bg="bg-warning">Software &
                                        Computer Services</option>
                                    <option value="Technology Hardware & Equipment" data-bg="bg-warning">Technology
                                        Hardware & Equipment</option>
                                    <option value="Telecommunications" data-bg="bg-secondary">Telecommunications
                                    </option>
                                    ...
                                    <option value="Architecture & Planning" data-bg="bg-warning">Architecture &
                                        Planning</option>
                                    <option value="Art & Handcraft" data-bg="bg-warning">Art & Handcraft</option>
                                    <option value="Aviation & Aerospace" data-bg="bg-secondary">Aviation & Aerospace
                                    </option>
                                    ...
                                    <option value="Entertainment & Events" data-bg="bg-warning">Entertainment & Events
                                    </option>
                                    ...
                                    <option value="Logistics & Supply Chain" data-bg="bg-success">Logistics & Supply
                                        Chain</option>
                                    <option value="Luxury Goods & Jewelry" data-bg="bg-danger">Luxury Goods & Jewelry
                                    </option>
                                    <option value="Manegement Consulting" data-bg="bg-warning">Manegement Consulting
                                    </option>
                                    <option value="Marketing & Advertising" data-bg="bg-warning">Marketing &
                                        Advertising</option>
                                    <option value="Music" data-bg="bg-secondary">Music</option>
                                    <option value="Pets" data-bg="bg-success">Pets</option>
                                    <option value="Political Organization" data-bg="bg-danger">Political Organization
                                    </option>
                        ...
                        <div class="col-md-12">
                            ...
                            <label> Condidential: The email of your client is confidential and will not be stored or
