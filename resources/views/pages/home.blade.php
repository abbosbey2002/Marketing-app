...
{{--                <a class="btn btn-brand-4-sm" href="#">How It Works</a>--}}
              <h2 class="mt-15 mb-20 text-center">Direct access to verified service<br class="d-none d-lg-block">providers in 1000+ services.</h2>
              <p class="text-lg neutral-500 mb-55 text-center">Discover the most relevant providers for your project based on your own specific requirements.</p>
                <div class="row">
...
{{--                  <p class="text-lg neutral-500">Bole nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo conididunt ut labore et dolore magna aliqua ut enim ad minim veniam</p>--}}
              ...
              <div class="row align-items-center">
                  <div class="col-lg-6 mb-30">
                      <h2>Drive revenue like never before.</h2>
...
{{--                                      </div>--}}
                  ...
                  <div class="col-lg-6 mb-30">
                      <div class="box-image-neutral-1000">
                          <img src="/assets/imgs/page/homepage1/marketing.jpg" alt="marketing" style="width: 100%;height: 300px;">
                      </div>
                  </div>
              </div>
          </div>
