                                        ...
                                        <table class="table table-hover" id="reviewsList">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td>
                                                            <a href="<?php echo e(route('reviews.show', $review->id)); ?>"
                                                                class="hstack gap-3">
                                                                <div>
                                                                    <span
                                                                        class="text-truncate-1-line"><?php echo e($review->user_full_name); ?></span>
                                                                </div>
                                                            </a>
                                                        </td>
                                                        <td><a href="#"><?php echo e($review->language->name ?? null); ?></a></td>
                                                        <td><a href="#"><?php echo e($review->provider->name ?? null); ?></a>
                                                        </td>
                                                        <td><a href=""><?php echo e($review->created_at); ?></a></td>
                                                        <td><a href="<?php echo e($review->link); ?>"
                                                                target="_blank"><?php echo e(__('Link')); ?></a></td>
                                                        <td>
                                                            <div class="hstack gap-2 justify-content-end">
                                                                <a href="javascript:void(0)" class="avatar-text avatar-md"
                                                                    data-bs-toggle="offcanvas"
                                                                    data-bs-target="#editReviewProviderOffcanvas<?php echo e($review->id); ?>">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbos/Desktop/projects/MARKETING/resources/views/admin/providers/reviews/index.blade.php ENDPATH**/ ?>