                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card-grid-2 card-employers hover-up wow animate__animated animate__fadeIn">
                                            ...
                                            <div class="text-center card-grid-2-image-rd online">
                                                <a href="<?php echo e(route('singlePartners')); ?>">
                                                    <figure><img alt="jobhub" src="/assets/imgs/employer-1.png" /></figure>
                                                </a>
                                            </div>
                                            <div class="card-block-info">
                                                <div class="card-profile">
                                                    <h5><a href="<?php echo e(route('singlePartners')); ?>"><strong>Invision</strong></a></h5>
                                                ...
                                                <div class="card-2-bottom card-2-bottom-candidate mt-30">
                                                    <div class="text-center mt-25 mb-5">
                                                        <a href="<?php echo e(route('singlePartners')); ?>"><button class="btn btn-brand-4-medium hover-up" style="margin: 0 auto;">12 Open Jobs</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card-grid-2 card-employers hover-up wow animate__animated animate__fadeIn">
                                            ...
                                            <div class="card-block-info">
                                                <div class="card-profile">
                                                    <h5><a href="<?php echo e(route('singlePartners')); ?>"><strong>Bing Search</strong></a></h5>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\MARKETING\resources\views/pages/page-partners.blade.php ENDPATH**/ ?>