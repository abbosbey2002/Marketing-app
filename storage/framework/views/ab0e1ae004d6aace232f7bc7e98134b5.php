                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card-grid-2 hover-up">
                                        ...
                                        <div class="text-center card-grid-2-image-rd online">
                                            <a href="<?php echo e(route('singleMarketers')); ?>">
                                                <figure><img alt="jobhub" src="/assets/imgs/img-candidate.png" /></figure>
                                            </a>
                                        </div>
                                        <div class="card-block-info">
                                            <div class="card-profile">
                                                 <a href="<?php echo e(route('singleMarketers')); ?>"><strong>Esther Howard</strong></a>
                                            ...
                                            <div class="card-2-bottom card-2-bottom-candidate mt-30">
                                                ...
                                                <div class="text-center mt-25 mb-5">
                                                    <a href="<?php echo e(route('singleMarketers')); ?>" class="btn btn-brand-4-medium hover-up" style="margin: 0 auto; display:inline">View profile</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\MARKETING\resources\views/pages/page-marketers.blade.php ENDPATH**/ ?>