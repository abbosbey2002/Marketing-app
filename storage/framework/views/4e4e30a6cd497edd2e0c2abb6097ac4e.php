                ...
                <div class="row align-items-center py-3 ">
                    <div class="col-lg-6">
                        <div class="box-form-register">
                            ...
                            <form class="form-register row" method="post" action="<?php echo e(route('providerRegisterStep2store')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbos/Desktop/projects/MARKETING/resources/views/auth/provider/register/step2.blade.php ENDPATH**/ ?>