                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled mb-4">
                                                <li class="hstack justify-content-between mb-4">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        class="float-end"><?php echo e(old('tagline', $provider->address)); ?></a>
                                                </li>
                                                <li class="hstack justify-content-between mb-4">
                                                    <span class="text-muted fw-medium hstack gap-3"><i
                                                ...
                                                <li class="hstack justify-content-between mb-0">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        class="float-end"><?php echo e(old('email', $provider->email)); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="d-flex align-items-center gap-3">
                                                                                        ...
                                                                                        <a href="javascript:void(0);">
                                                                                            <span
                                                                                                class="d-block"><?php echo e($provider->manager_name); ?></span>
                                                                                            <span
                                                                                                class="fs-12 d-block fw-normal text-muted"><?php echo e($provider->manager_email); ?></span>
                                                                                        </a>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
