            ...
            <div class="row">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="service-type" id="edit-service-type-<?php echo e($service->id); ?>" class="form-control">
                            <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option class="text-black"  value="<?php echo e($serviceType->id); ?>" <?php echo e($serviceType->id == $service->service_type ? 'selected' : ''); ?>>
                        ...
                        <select name="skills[]" id="edit-skills-list-<?php echo e($service->id); ?>" class=" select22" multiple="multiple">
                            <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($skill->id); ?>"
                                    <?php if(in_array($skill->id, $service->skills->pluck('id')->toArray())): ?> selected <?php endif; ?>>
                                    <?php echo e($skill->name_en ?? $skill->name); ?>
                        ...
                        <div class="row mt-2">
                            <div class="col d-flex align-items-center">
                                <label for="edit-custom-price-<?php echo e($service->id); ?>" class="d-flex align-items-center">
                                    <input type="number" class="ms-2 p-1" id="edit-custom-price-input-<?php echo e($service->id); ?>" name="startingPrice" value="<?php echo e($service->startingPrice); ?>" placeholder="€20000"/>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control" name="description" style="height: 18em;"><?php echo e($service->description); ?></textarea>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/dorauz/domains/marketing.dora.uz/public_html/resources/views/admin/components/services/provider-service-edit-modal.blade.php ENDPATH**/ ?>