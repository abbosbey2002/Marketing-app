<?php $__env->startSection('title', 'Provider Login'); ?>
            ...
            <div class="row align-items-center gap-sb-3 d-flex justify-content-center">
                <div class="col-lg-6 d-flex justify-content-center align-items-center">
                    <div class="box-form-register">
                        ...
                        <form class="form-register" method="POST" action="<?php echo e(route('provider.login')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="other-login">
                                <p class="text-md neutral-500">Don’t have an account?&nbsp;<a class="brand-1-1" href="<?php echo e(route('providerRegisterStep1')); ?>">Sign Up</a></p>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Owner\Desktop\Web project\marketing.dora.uz\public_html\resources\views/auth/provider/login/index.blade.php ENDPATH**/ ?>