                                        ...
                                        <div class="w-100 d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0)" class="d-flex align-items-center mb-1" data-bs-toggle="offcanvas" data-bs-target="#editServiceModal<?php echo e($service->id); ?>">
                                                        <?php echo e($service->serviceList->name_en ?? 'No Service List'); ?>

                                                    </a>
                                                    <div class="fs-12 fw-normal text-muted">       
                                                        <!-- Display Skills -->
                                                        <?php if($service->skills->isNotEmpty()): ?>
                                                            <ul>
                                                                <?php $__currentLoopData = $service->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li><?php echo e($skill->name_en ?? $skill->name); ?></li> <!-- Displaying each skill in English or fallback -->
                                            ...
                                            <div class="hstack gap-2 justify-content-end">
                                                <!-- Edit Button -->
                                                <a href="javascript:void(0);" class="avatar-text avatar-md" data-bs-toggle="offcanvas" data-bs-target="#editServiceModal<?php echo e($service->id); ?>">
                                                    <i class="feather feather-edit-3"></i>
                                                </a>
                                                
                                                <!-- Delete Button -->
                                                <form class="avatar-text avatar-md" method="POST" onsubmit="confirmDelete(event)" action="<?php echo e(route('services.destroy', $service->id)); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dorauz/domains/marketing.dora.uz/public_html/resources/views/admin/providers/services/index.blade.php ENDPATH**/ ?>