    ...
    <div class="container">
        ...
        <div class="col-lg-6">
            <div class="box-form-register">
                ...
                <form class="form-register row" action="<?php echo e(route('providerRegisterStep3')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nazarbek/server/MARKETING/resources/views/auth/provider/register/step3.blade.php ENDPATH**/ ?>