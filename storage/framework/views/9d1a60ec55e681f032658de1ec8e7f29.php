...
<!--! ================================================================ !-->
<form action="<?php echo e(route('providers.add.service')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
<!--! ================================================================ !-->
<?php /**PATH /home/abbos/Desktop/projects/MARKETING/resources/views/admin/components/services/provider-service-modal.blade.php ENDPATH**/ ?>