<!--! ================================================================ !-->
    ...
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="managerProviderOffcanvas">
        ...
        <form action="<?php echo e(route('managers.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <!--! ================================================================ !--><?php /**PATH /home/dorauz/domains/marketing.dora.uz/public_html/resources/views/admin/components/managers/provider-manager-modal.blade.php ENDPATH**/ ?>