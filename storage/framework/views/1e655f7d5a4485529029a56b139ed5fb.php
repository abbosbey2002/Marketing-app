<?php $__env->startSection('content'); ?>
                                        ...
                                        <div class="w-100 d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="javascript:void(0)" class="d-flex align-items-center mb-1"
                                                        ...
                                                        data-bs-target="#portfolioProviderEditOffcanvas<?php echo e($portfolio->id); ?>"><?php echo e($portfolio->name); ?></a>
                                            ...
                                            <div class="hstack gap-2 justify-content-end">
                                                <a href="javascript:void(0);" class="avatar-text avatar-md"
                                                    data-bs-toggle="offcanvas"
                                                    data-bs-target="#portfolioProviderEditOffcanvas<?php echo e($portfolio->id); ?>">
                                                    <i class="feather feather-edit-3 "></i>
                                                </a>
                                                <form class="avatar-text avatar-md" method="POST"
                                                    onsubmit="confirmDelete(event)"
                                                    action="<?php echo e(route('portfolios.destroy', $portfolio->id)); ?>">
                                                    <?php echo csrf_field(); ?>
    ...
    <?php echo $__env->make('admin.components.portfolios.provider-portfolio-modal', ['services' => $services], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbos/Desktop/projects/MARKETING/resources/views/admin/providers/portfolios/index.blade.php ENDPATH**/ ?>